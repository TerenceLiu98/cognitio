...
- M0-M6 的稳定化代码路径已完成；状态操作、任务 trailer、发布恢复、解析 manifest、流式 MinerU I/O、设置一致性、诊断脱敏和 Pages 独立状态已落地。
- M7 的自动检查、源码说明和 arm64 本地 `.app` 路径已完成；真实 GitHub、Precision 和三种 Agent 凭据 smoke test 仍是发布门槛，详见 `docs/DEVELOPER_PREVIEW.md`。
